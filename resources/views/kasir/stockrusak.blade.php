...
<div class="container">
  ...
  <form action="{{url('stock/stockrusak/'.$stocks->id)}}" method="POST">
    ...
    <div class="form-group">
        <label for="stock">Jumlah Stok Rusak</label>
        <input type="number" min="1" class="form-control" id="stock" placeholder="Masukkan jumlah stok rusak" name="stock">
    </div>    
    <div class="form-group">
