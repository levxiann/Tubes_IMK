            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="login-pass">
                    <label for="password">
                        ...
                        <input class="form-control  @error('password') is-invalid @enderror" id="password" type="password" placeholder="Masukkan Password" required autocomplete="current-password">
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="submit-button">
                    <button type="button" class="btn btn-login">{{ __('Login') }}</button>
